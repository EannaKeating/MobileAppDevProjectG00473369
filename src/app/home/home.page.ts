...
import { TmdbService } from '../services/tmdb.service';// handles API
...
export class HomePage {
  ...
  // runs when page loads, fetches trending movies
  async ngOnInit(){
